<template>
  <div :id="elKey" class="feedback">
    <div
      class="feedback-rate-btns"
      :style="{
        padding: wndw.wdth > respWidth.md ? '0px 10%' : '0px 5px',
      }"
    >
    ...
    <div
      ...
      :style="{
        padding: wndw.wdth > respWidth.md ? '0px 10%' : '5px',
      }"
    >
    ...
    <div
      style="width: 100%"
      :style="{
        padding: wndw.wdth > respWidth.md ? '0px calc(10% + 7.5px)' : '10px',
      }"
    >
      <div
        :style="{
